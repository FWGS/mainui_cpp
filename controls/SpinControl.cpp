...
void CMenuSpinControl::Draw( void )
{
	...
	{
		UI_DrawString( font, m_scCenterPos, m_scCenterBox, m_szDisplay, uiColorDkGrey, true, m_scChSize, eTextAlignment, shadow );
	...
	{
		UI_DrawString( font, m_scCenterPos, m_scCenterBox, m_szDisplay, iColor, false, m_scChSize, eTextAlignment, shadow );
	...
	{
		UI_DrawString( font, m_scCenterPos, m_scCenterBox, m_szDisplay, iFocusColor, false, m_scChSize, eTextAlignment, shadow );
	...
	else if( eFocusAnimation == QM_PULSEIFFOCUS )
	{
		...
		UI_DrawString( font, m_scCenterPos, m_scCenterBox, m_szDisplay, color, false, m_scChSize, eTextAlignment, shadow );
